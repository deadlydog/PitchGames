...
namespace FMOD
{
    ...
    */
    ...
    {
        public const int    number = 0x00041203;
    ...
    */
    public enum INITFLAG
    {
		...
		ENABLE_DSPNET           = 0x00000020,   /* All platforms - Enable TCP/IP based host which allows "DSPNet Listener.exe" to connect to it, and view the DSP dataflow network graph in real-time. */
